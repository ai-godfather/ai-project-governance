...
| Zone | Reason |
|------|--------|
| `docs/JOBS/` | Extensive job documentation, curated over time |
| `docs/INFRASTRUCTURE/` | Critical infrastructure docs |
...
- ✅ Reference concrete file paths (e.g., `server/services/example.ts`)
...
- Role Definition: `core/roles/CODE_DOCUMENTATOR.md`
